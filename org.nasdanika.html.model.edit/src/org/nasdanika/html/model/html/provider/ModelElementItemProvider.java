...
/**
 * This is the item provider adapter for a {@link org.nasdanika.html.model.html.ModelElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelElementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HtmlPackage.Literals.MODEL_ELEMENT__DESCRIPTION,
				 true,
				 true,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HtmlPackage.Literals.MODEL_ELEMENT__ANNOTATIONS);
		}
	...
	public String getText(Object object) {
		String label = crop(((ModelElement)object).getDescription());
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ModelElement.class)) {
			case HtmlPackage.MODEL_ELEMENT__DESCRIPTION:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case HtmlPackage.MODEL_ELEMENT__ANNOTATIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HtmlPackage.Literals.MODEL_ELEMENT__ANNOTATIONS,
