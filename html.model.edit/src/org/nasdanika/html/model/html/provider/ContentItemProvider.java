...
/**
 * This is the item provider adapter for a {@link org.nasdanika.html.model.html.Content} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContentItemProvider extends ModelElementItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = crop(((Content)object).getDescription());
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Content.class)) {
			case HtmlPackage.CONTENT__DATA_BINDING:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case HtmlPackage.CONTENT__ITERATOR:
			case HtmlPackage.CONTENT__FACETS:
