...
/**
 * This is the item provider adapter for a {@link org.nasdanika.html.model.html.Case} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CaseItemProvider extends CDOItemProviderAdapterEx implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Case_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Case_value_feature", "_UI_Case_type"),
				 HtmlPackage.Literals.CASE__VALUE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HtmlPackage.Literals.CASE__CONTENT);
		}
	...
	public String getText(Object object) {
		String label = ((Case)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Case.class)) {
			case HtmlPackage.CASE__VALUE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case HtmlPackage.CASE__CONTENT:
