...
/**
 * This is the item provider adapter for a {@link org.nasdanika.html.model.bootstrap.ContainerBootstrapElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContainerBootstrapElementItemProvider extends ContentBootstrapElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ContainerBootstrapElementItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns ContainerBootstrapElement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ContainerBootstrapElement"));
	}
	...
	public String getText(Object object) {
		String label = ((ContainerBootstrapElement)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ContainerBootstrapElement_type") :
			getString("_UI_ContainerBootstrapElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ContainerBootstrapElement.class)) {
			case BootstrapPackage.CONTAINER_BOOTSTRAP_ELEMENT__CONTENT:
