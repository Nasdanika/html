...
See [Nasdanika Core EMF](../core/emf.html).
...
Element icon, color and outline flag may be customized by adding an annotation to the corresponding EMF model element with source ``org.nasdanika`` and the following detail keys:
