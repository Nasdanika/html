...
[Bank model documentation](tests/dumps/ecore/index.html) is an example of an SPA (Single-page application) generated by leveraging EcoreDocumentationApplication.   
