...
/**
 * Interface for setting Bootstrap classes.
 * @author Pavel Vlasov
 *
 * @param <T>
 */
public interface Bootstrap<T extends HTMLElement<?>> extends BootstrapElement<T> {
	...
	interface Grid<T extends HTMLElement<?>> extends AutoCloseable {
		
		Bootstrap<T> container();
		Bootstrap<T> fluidContainer();
		Bootstrap<T> row();
		Bootstrap<T> col(Bootstrap.DeviceSize deviceSize, int width);
		 ...
		 * @return
		 */
		Bootstrap<T> col(int width);
		
		Bootstrap<T> colOffset(Bootstrap.DeviceSize deviceSize, int width);
		Bootstrap<T> colOffset(int width);

		Bootstrap<T> colPush(Bootstrap.DeviceSize deviceSize, int width);
		Bootstrap<T> colPush(int width);

		Bootstrap<T> colPull(Bootstrap.DeviceSize deviceSize, int width);
		Bootstrap<T> colPull(int width);

	}	
	
	Grid<T> grid();
	
	Bootstrap<T> background(Style style);
	
	Bootstrap<T> pullLeft();
	
	Bootstrap<T> pullRight();
	
	Bootstrap<T> centerBlock();
	
	Bootstrap<T> clearfix();
	
	interface Text<T extends HTMLElement<?>> {
		
		Bootstrap<T> color(Style style);
		...
		Bootstrap<T> lowercase();
		
		Bootstrap<T> uppercase();
		
		Bootstrap<T> capitalize();		
	...
	Bootstrap<T> visibleBlock(DeviceSize deviceSize);
	
	Bootstrap<T> visibleInline(DeviceSize deviceSize);
	
	Bootstrap<T> visibleInlineBlock(DeviceSize deviceSize);
	
	Bootstrap<T> hidden(DeviceSize deviceSize);
