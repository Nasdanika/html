...
public class ParticipantActionSupplier extends PackageElementActionSupplier<Participant> {
	
	public ParticipantActionSupplier(Participant value, Context context) {
		super(value, context);
	}
