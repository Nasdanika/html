...
public class AppValidator extends EObjectValidator {
	...
	public boolean validateLabel(Label label, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= bootstrapValidator.validateItem_color(label, diagnostics, context);
	...
	public boolean validateLink(Link link, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= bootstrapValidator.validateItem_color(link, diagnostics, context);
		if (result || diagnostics != null) result &= bootstrapValidator.validateItem_activeAndDisabled(link, diagnostics, context);
		if (result || diagnostics != null) result &= validateLink_activator(link, diagnostics, context);
		return result;
	}

	/**
	 * Validates the activator constraint of '<em>Link</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateLink_activator(Link link, DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(createDiagnostic
						(Diagnostic.ERROR,
						 ...
						 new Object[] { "activator", getObjectLabel(link, context) },
						 new Object[] { link },
						 context));
			}
			return false;
	...
	public boolean validateAction(Action action, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= bootstrapValidator.validateItem_color(action, diagnostics, context);
