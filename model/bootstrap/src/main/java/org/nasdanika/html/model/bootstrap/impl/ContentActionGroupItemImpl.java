...
public class ContentActionGroupItemImpl extends ActionGroupItemImpl implements ContentActionGroupItem {
	...
	public EList<EObject> getContent() {
		return (EList<EObject>)eDynamicGet(BootstrapPackage.CONTENT_ACTION_GROUP_ITEM__CONTENT, BootstrapPackage.Literals.CONTENT_ACTION_GROUP_ITEM__CONTENT, true, true);
	}
